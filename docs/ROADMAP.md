...
- **Phase 3 — dashboard/UX.** Redesign the graphs flagged in STATUS, address polling/lag, visual polish.
...
> Done in Phase 1 (2026-06-12): GitHub Actions CI, 34-test core-api pytest suite, Alembic migrations, fully pinned requirements, ruff lint baseline. See [../TESTING.md](../TESTING.md).
